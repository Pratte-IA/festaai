-- Pacote contratado: apenas seleção do pacote; valor e demais dados vêm do sistema.
...
set
  ...
  field_type = 'select',
  description = 'Lista os pacotes ativos cadastrados na central de controle. O valor é calculado automaticamente conforme o pacote e a quantidade de convidados.'
...
begin
  ...
  values
    ...
    (new.id, 'pacote', 'Pacote contratado', 'pacote_nome', 'select', true, true, 1, true, 'comercial', true, true, true, true, true),
