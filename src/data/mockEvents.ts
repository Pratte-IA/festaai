...
export type SalesStage = "contato_inicial" | "proposta_enviada" | "negociacao" | "visita_agendada" | "contrato" | "perdido";
...
export const mockEvents: Event[] = [
  ...
  { id: "9", clientName: "Tatiana Alves", birthdayChildName: "Alice", birthDate: "2020-05-20", phone: "(11) 99999-9999", partyDate: "2026-05-15", partyTime: "15:00", selectedPackage: "Pacote Ouro", packageValue: 3200, addonsValue: 600, totalValue: 3800, downPayment: 1200, payments: [{ id: "p14", date: "2026-03-25", amount: 1200 }, { id: "p15", date: "2026-04-09", amount: 800 }], guestCount: 55, funnel: "festa", stage: "boas_vindas", status: "ativo", eventType: "festa", createdAt: "2026-03-25", updatedAt: "2026-04-09" },
