...
const STATUS_VARIANTS: Record<CrmStatus, string> = {
  ...
  prospecting: "border-transparent bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-200",
  contacted: "border-transparent bg-indigo-100 text-indigo-800 dark:bg-indigo-950 dark:text-indigo-200",
  responded: "border-transparent bg-violet-100 text-violet-800 dark:bg-violet-950 dark:text-violet-200",
  meeting_scheduled: "border-transparent bg-amber-100 text-amber-800 dark:bg-amber-950 dark:text-amber-200",
  ...
  do_not_contact: "border-transparent bg-muted text-muted-foreground line-through",
};
